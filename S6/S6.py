...
out_folder = 'S6_results'
fem_fig_folder = "S6_figs"
...
domains = df.MeshFunction("size_t", mesh, 'S6_physical_region.xml')
boundaries = df.MeshFunction("size_t", mesh, 'S6_facet_region.xml')
